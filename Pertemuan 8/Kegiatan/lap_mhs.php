...
$pdf->Cell(190, 7, 'PROGRAM STUDI TEKNIK INFORMATIKA', 0, 1, 'C'); // Mencetak string (width, height, text, border, ln(pindah baris), align);
$pdf->SetFont('Arial', 'B', 12); // Menentukan jenis font yang akan digunakan
$pdf->Cell(190, 7, 'DAFTAR MAHASISWA MAKUL PEMROGRAMAN WEB DINAMIS', 0, 1, 'C'); // Mencetak string (width, height, text, border, ln(pindah baris), align);
